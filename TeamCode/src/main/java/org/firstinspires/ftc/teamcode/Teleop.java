...
@TeleOp(name = "ChrisTeleOp", group = "TeleOp")
public class Teleop extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.arm.motor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        robot.slider.motor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
